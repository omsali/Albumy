...
def test_direct_upload():
    ...
    try:
        ...
        with app.app_context():
            ...
            test_image = upload_path / 'test_direct_upload.jpg'
            img = Image.new('RGB', (400, 300), color='blue')
            img.save(test_image)
            print(f"✓ Created test image: {test_image}")
            
            # Test 1: Upload with description
            print("\n1. Testing upload WITH description:")
            print("-" * 40)
            
            photo1 = Photo(
                filename='test_direct_upload.jpg',
                filename_s='test_direct_upload_s.jpg',
                filename_m='test_direct_upload_m.jpg',
            ...
            try:
                ...
                if photo1.description == 'My custom description':
            ...
            test_image2 = upload_path / 'test_no_desc_direct.jpg'
            img2 = Image.new('RGB', (400, 300), color='green')
            img2.save(test_image2)
            
            photo2 = Photo(
                filename='test_no_desc_direct.jpg',
                filename_s='test_no_desc_direct_s.jpg',
                filename_m='test_no_desc_direct_m.jpg',
